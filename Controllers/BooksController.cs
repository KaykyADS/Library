...
namespace Biblioteca.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var context = _context.Books.Include(b => b.Author);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,PublicationYear,Available,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,PublicationYear,Available,AuthorId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
